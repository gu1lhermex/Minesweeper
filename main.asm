...
.data
	msg_row:  		.asciiz "Digite a linha: "
 	msg_column:  	.asciiz "Digite a coluna: "
 	msg_win:  		.asciiz "venceu! Parabéns você ganhou!\n"
 	msg_lose:  		.asciiz "perdeu! Você perdeu.\n"
	msg_invalid: 	.asciiz "Movimento invalido.Digite novamente\n"
